  ...
  const incoming: DeckBackup[] = [
    {
      ...
      cards: [
        { front: 'hola', back: 'hello', createdAt: 1, updatedAt: 1, tags: [], suspended: false, scheduling: { kind: 'fsrs', stability: 0, difficulty: 0, reps: 0, lapses: 0, state: 0, step: 0, lastReview: null, due: 1 } },
      ],
    },
  ]
